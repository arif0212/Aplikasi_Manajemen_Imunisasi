...
<div class="main-content-container container-fluid px-4">
        ...
        <div class="col-md">
            <div class="card">
                <div class="card-body text-center ">
                    ...
                    <h5>Selamat Datang di aplikasi Posyandu Puskesmas Kraton</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="stats-small stats-small--1 card card-small">
            ...
            <div class="d-flex flex-column m-auto">
                <div class="stats-small__data text-center">
                <span class="stats-small__label text-uppercase">Ibu</span>
                <h6 class="stats-small__value count my-3">{{$ibu}} <small>orang</small></h6>
                </div>
            </div>
