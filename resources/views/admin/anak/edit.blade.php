                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="input-group input-group-seamless">
                                ...
                                <input type="text" name="nama_anak" class="form-control" id="form1-username"
                                    placeholder="Nama Anak" value="{{$data->nama_anak}}" required>
                            </div>
                        </div>
                            ...
                            <div class="form-inline">
                                <div class="custom-control custom-radio mb-1 mr-3">
                                    <input type="radio" id="formsRadioDefault1" name="jk" value="Laki-laki"
                                        class="custom-control-input" {{$data->jk == 'Laki-laki' ? 'checked' : ''}}>
                                ...
                                <div class="custom-control custom-radio mb-1">
                                    <input type="radio" id="formsRadioDefault2" name="jk" value="Perempuan"
                                        class="custom-control-input" {{$data->jk == 'Perempuan' ? 'checked' : ''}}>
                        ...
                        <div class="col-md">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group input-group-seamless">
                                    ...
                                    <input type="text" name="nama_ibu"  value="{{$data->nama_ayah}}"
                                    class="form-control" id="form1-username"placeholder="Nama Ibu" required>
                                </div>
                            </div>
                        </div>
                            <div class="col-md">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group input-group-seamless">
                                        ...
                                        <input type="text" name="nama_ayah" value="{{$data->nama_ayah}}"
                                            class="form-control" id="form1-username" placeholder="Nama Ayah" required>
                                    </div>
                                </div>
                            </div>
                        </div>
