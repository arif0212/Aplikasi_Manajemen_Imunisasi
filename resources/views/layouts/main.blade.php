...
<head>
  ...
  <title>Manajemen Imunisasi</title>
      ...
      <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
        <div class="main-navbar">
          <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
            <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 30px;">
              <div class="d-table m-auto">
                ...
                <span class="d-none d-md-inline mt-1">Posyandu Yogyakarta</span>
              </div>
            </a>
        ...
        <div class="nav-wrapper">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link " href="{{Route('admin.bidan.index')}}">
            ...
            <li class="nav-item">
              <a class="nav-link " href="{{Route('admin.ibu.index')}}">
            ...
            <li class="nav-item">
              <a class="nav-link " href="/admin/anak/">
